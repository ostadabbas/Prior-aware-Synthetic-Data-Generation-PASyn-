...
parser.add_argument('--batch_mode', default=True, type=bool, help="decide whether a path or a file")
...
if args.batch_mode == True:
    for content_path in content_paths:
        for style_path in style_paths:
            ...
            output = output[0].cpu()
            output2 = content/2+output/2
            output2_PIL_T = transforms.ToPILImage()
            output2_PIL = output2_PIL_T(output2[0])
            ...
            # save_image(output2, output2_name)
